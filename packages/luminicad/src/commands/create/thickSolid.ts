import { EditableShapeNode, I18n, Property, ShapeType, command } from "luminicad-core";
...
@command({
    ...
    icon: `<svg viewBox="0 0 511.873 511.873" fill="none">
        <polygon points="159.937,166.72 159.937,454.72 143.937,448 31.937,400 31.937,256 31.937,112 47.937,118.72 
            143.937,160" fill="#1F77B4" opacity="0.7"></polygon>
        <polygon points="271.937,22.72 383.937,70.72 271.937,118.72 159.937,166.72 143.937,160 47.937,118.72 
            31.937,112 143.937,64 255.937,16" fill="#1F77B4" opacity="0.7"></polygon>
        <path d="M390.241,56.016l-112-48l-0.112-0.048l-16-6.72c-4-1.68-8.512-1.664-12.496,0.048l-112,48l-112,48
            ...
            L265.633,104.016z" fill="#808080"></path>
        <polygon points="479.937,256 479.937,400 367.937,448 255.937,496 255.937,352 255.937,208 367.937,160 
            479.937,112" fill="#FFFFFF" opacity="0.2"></polygon>
        <polygon points="271.937,118.72 383.937,70.72 479.937,112 367.937,160 255.937,208 159.937,166.72" fill="#FFFFFF" opacity="0.2"></polygon>
        <polygon points="255.937,208 255.937,352 255.937,496 159.937,454.72 159.937,166.72" fill="#FFFFFF" opacity="0.2"></polygon>
        <path d="M495.297,107.68c-0.128-0.464-0.336-0.864-0.512-1.296c-0.336-0.912-0.72-1.776-1.216-2.608
            ...
            l-89.696,38.432V352V218.544l102.304-43.84l89.696-38.432V256V389.456z" fill="#808080"></path>
    </svg>`,
})
