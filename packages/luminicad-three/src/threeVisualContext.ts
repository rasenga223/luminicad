...
export class ThreeVisualContext implements IVisualContext {
    ...
    constructor(
        ...
        // Populate initial materials into Three.js materialMap so that pre-existing materials are available
        // This ensures shapes rendered immediately after viewport initialization receive their correct materials
        visual.document.materials.forEach(this.createThreeMaterial.bind(this));
    }
