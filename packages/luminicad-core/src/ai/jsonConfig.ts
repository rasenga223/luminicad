// System configuration for the JSON-based AI generation flow.
// This prompt instructs the model to output valid LuminiCAD JSON that our
// JsonExecutionService can import directly. Kept self-contained so it can be
// swapped in/out similarly to the existing CadQuery config.
